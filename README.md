...
<idea-plugin>
  <id>org.jetbrains.plugins.poporg.jetbrains.plugins.pop</id>
  <name>Template</name>
...
```
.
├── PopBundle.kt                         Bundle class providing access to the resources messages
├── listeners
...
>>>>>>> 22dd244 (Applied project templates)
